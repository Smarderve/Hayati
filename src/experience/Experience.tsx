...
import { WebGLBoundary } from "@/src/experience/WebGLBoundary";
...
function Wordmark({ finale = false }: { finale?: boolean }) {
  return <section className={finale ? "title-card finale" : "title-card opening"} aria-label="Hayati, A Fairytale of the Two Kingdoms"><Image className="hayati-wordmark" src="/brand/hayati-wordmark.png" alt="Hayati" width={842} height={371} loading="eager" /><p>A Fairytale of the Two Kingdoms</p><DownloadBookButton /></section>;
}
...
export function Experience() {
  ...
  return <main className="experience"><div className="poster-fallback" aria-hidden="true" /><WebGLBoundary><FilmWorld /></WebGLBoundary><div className="film-grain" aria-hidden="true" /><div className="cinema-vignette" aria-hidden="true" /><div ref={opening}><Wordmark /></div><div ref={finale}><Wordmark finale /></div><div className="scroll-track" aria-hidden="true" /></main>;
}
